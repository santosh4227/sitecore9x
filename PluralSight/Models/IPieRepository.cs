...
namespace PluralSight.Models
{
    ...
    public class PieRepository : IPieRepository
    {
        ...
        public PieRepository(AppDbContext _db)
        {
            _appDbContext = _db;
        }
        public IEnumerable<Pie> AllPie => _appDbContext.Pies.Include(x => x.Category);

        public IEnumerable<Pie> PiesOfTheWeek => _appDbContext.Pies.Include(x => x.Category).Where(y => y.IsPieOfTheWeek);
    ...
    public class MockPieRepository : IPieRepository
    {
        ...
        public ICategoryRepository _categoryRepository = new MockCategoryRepository();
        public IEnumerable<Pie> AllPie => new List<Pie>
            {
        ...
        public Pie GetPie(int id)
        {
            return AllPie.SingleOrDefault(x => x.PieId == id);
        }
    }
}
